...
import { useForceUpdate, useIsomorphicLayoutEffect } from '../../hooks';
import { createContext, isBrowser } from '../../utils';
...
const PORTAL_CLASSNAME = 'ecommerce-portal';
const PORTAL_SELECTOR = `.ecommerce-portal`;

const Container: React.FC<{ zIndex: number }> = (props) => (
  <div
    className='ecommerce-portal-zIndex'
    style={{
      position: 'absolute',
      zIndex: props.zIndex,
      top: 0,
